...
source <(curl -sL https://raw.githubusercontent.com/hectorsiglo21/TEST/main/ArchivosUtilitarios/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/hectorsiglo21/TEST/main/ArchivosUtilitarios/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
